...
*/
DESCRIPTION: EXPERIEMENT-1: ALL TASKS ARE NORMAL TASKS except TASK3 in Server1
...
------------------------------
	...
	init_server(&SERVERS[1], 1, 40, 16, 1, 0,100); //WITHOUT MEMORY THROTTLING AND THEN WITH THROTTLING WITH BUDGET 100 IN THE PAPER
