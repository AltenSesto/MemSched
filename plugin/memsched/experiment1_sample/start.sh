...
./normal_task 98 60 8  $1 T3 1 10 &

#./problem_task 98 40 8  $1 T3 1 10 &   For experiment2 of the paper remove third task and use this memory-intensive one. Or simply use experiment2_sample code
