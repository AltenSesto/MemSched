 ...
 */
/*
 * schedbench.c:	schedulability benchmark
 */
...
void help(void)
{
	...
	printf("--pmin=		the minimum period of every individual task (by milisecond).\n");
	printf("--pmax=		the maximum period of every individual task (by milisecond).\n");
...
int main(int argc, char *argv[])
{
	...
	/* minimum/maximum period of individual task (milisecond).
	...
	/* measure the cycles that consume 1 milisecond. 
